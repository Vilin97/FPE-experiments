...
xs, Δts, b, D, ρ₀, target = moving_trap(50, 100)
...
sbtm_trajectories, losses, s_values = sbtm(xs, Δts, b, D, s; optimiser = Adam(10^-3), epochs = epochs, record_losses = true, verbose = true)
t4 = time()
...
save("moving_trap_data.jld", "sbtm_trajectories", sbtm_trajectories, "losses", losses, "s_values", s_values, "jhu_trajectories", jhu_trajectories, "timestamps", [t1, t2, t3, t4])
